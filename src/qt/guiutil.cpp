...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("moodcoin"))
        return false;
...
{
    // Convert Moodcoin:// to Moodcoin:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("moodcoin://"))
    {
        uri.replace(0, 12, "moodcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "moodcoin.lnk";
}
...
{
    return GetAutostartDir() / "moodcoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Moodcoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Moodcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QTableView { color: rgb(255,255,255); alternate-background-color: rgb(255,80,0); background-color: rgb(255,80,0); gridline-color: rgb(90,104,118); }"
                      "QWidget        { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      ...
                      "QPushButton    { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QMenuBar       { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QMenu          { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QMenuBar::item {background-color: transparent;}"
                      "QMenu::item:selected { background-color: rgb(255,80,0); }"
                      "QTreeView::item { background-color: rgb(255,80,0); }"
                      "QTreeView::item:selected { background-color: rgb(255,80,0); }"
                      "QHeaderView::section { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QToolBar       { background-color: rgb(255,80,0); border: none; }"
                      "QTextEdit      { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QPlainTextEdit { background-color: rgb(178,178,178); color: rgb(255,255,255); }"
                      "QComboBox      { background-color: rgb(255,80,0); color: rgb(255,255,255); }"
                      "QComboBox QAbstractItemView::item { color: rgb(255,80,0); }"
