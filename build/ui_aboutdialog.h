...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        QBrush brush6(QColor(178, 178, 178, 255));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Moodcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Moodcoin", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2015 The Moodcoin Developers", 0));
