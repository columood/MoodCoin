...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        QBrush brush7(QColor(178, 178, 178, 255));
        ...
        passEdit1->setAutoFillBackground(false);
        passEdit1->setStyleSheet(QLatin1String("background-color: rgb(178, 178, 178);\n"
"color: rgb(255,255,255);"));
        ...
        passEdit2->setAutoFillBackground(false);
        passEdit2->setStyleSheet(QLatin1String("background-color: rgb(178, 178, 178);\n"
"color: rgb(255,255,255);"));
        ...
        passEdit3->setAutoFillBackground(false);
        passEdit3->setStyleSheet(QLatin1String("background-color: rgb(178, 178, 178);\n"
"color: rgb(255,255,255);"));
        ...
        stakingCheckBox->setStyleSheet(QLatin1String("background-color: rgb(255, 80, 0);\n"
"color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        passLabel1->setText(QApplication::translate("AskPassphraseDialog", "<html><head/><body><p><span style=\" color:#ffffff;\">Enter passphrase</span></p></body></html>", 0));
        passLabel2->setText(QApplication::translate("AskPassphraseDialog", "<html><head/><body><p><span style=\" color:#ffffff;\">New passphrase</span></p></body></html>", 0));
        passLabel3->setText(QApplication::translate("AskPassphraseDialog", "<html><head/><body><p><span style=\" color:#ffffff;\">Repeat new passphrase</span></p></body></html>", 0));
