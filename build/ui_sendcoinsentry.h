...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount->setStyleSheet(QStringLiteral("background-color: rgb(178, 178, 178);"));
        ...
        addAsLabel->setStyleSheet(QStringLiteral("background-color: rgb(178, 178, 178);"));
        ...
        payTo->setStyleSheet(QStringLiteral("background-color: rgb(178, 178, 178);"));
