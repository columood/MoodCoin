...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        QBrush brush6(QColor(255, 80, 0, 255));
        ...
        QBrush brush9(QColor(76, 76, 76, 255));
        ...
        tabWidget->setStyleSheet(QStringLiteral("background-color: rgb(255, 80, 0);"));
        ...
        startupTime->setPalette(palette11);
        ...
        numberOfConnections->setPalette(palette14);
        ...
        numberOfBlocks->setPalette(palette18);
        ...
        totalBlocks->setPalette(palette20);
        ...
        lastBlockTime->setPalette(palette22);
        ...
        labelDebugLogfile->setPalette(palette23);
        ...
        QPalette palette24;
        QBrush brush10(QColor(60, 60, 60, 255));
        ...
        palette24.setBrush(QPalette::Active, QPalette::Mid, brush);
        ...
        palette24.setBrush(QPalette::Active, QPalette::Highlight, brush12);
        ...
        palette24.setBrush(QPalette::Inactive, QPalette::Mid, brush);
        ...
        palette24.setBrush(QPalette::Inactive, QPalette::Highlight, brush11);
        ...
        palette24.setBrush(QPalette::Disabled, QPalette::Mid, brush);
        ...
        openDebugLogfileButton->setPalette(palette24);
        ...
        labelCLOptions->setPalette(palette25);
        ...
        palette26.setBrush(QPalette::Active, QPalette::Highlight, brush12);
        ...
        palette26.setBrush(QPalette::Inactive, QPalette::Highlight, brush11);
        ...
        showCLOptionsButton->setPalette(palette26);
        ...
        gridLayout->addWidget(label_15, 4, 1, 1, 1);
        ...
        palette27.setBrush(QPalette::Active, QPalette::NoRole, brush);
        ...
        palette27.setBrush(QPalette::Inactive, QPalette::NoRole, brush);
        ...
        palette27.setBrush(QPalette::Disabled, QPalette::NoRole, brush);
        palette27.setBrush(QPalette::Disabled, QPalette::ToolTipBase, brush8);
        messagesWidget->setPalette(palette27);
        ...
        palette29.setBrush(QPalette::Active, QPalette::Text, brush13);
        palette29.setBrush(QPalette::Active, QPalette::ButtonText, brush13);
        ...
        palette29.setBrush(QPalette::Inactive, QPalette::Text, brush13);
        palette29.setBrush(QPalette::Inactive, QPalette::ButtonText, brush13);
        ...
        palette29.setBrush(QPalette::Disabled, QPalette::AlternateBase, brush8);
        lineEdit->setPalette(palette29);
        lineEdit->setFocusPolicy(Qt::NoFocus);
        lineEdit->setAutoFillBackground(false);
        lineEdit->setStyleSheet(QStringLiteral("background-color: rgb(178, 178, 178);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Moodcoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Moodcoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Moodcoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Moodcoin-Qt help message to get a list with possible Moodcoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
        showCLOptionsButton->setText(QApplication::translate("RPCConsole", "&Show", 0));
        label_15->setText(QApplication::translate("RPCConsole", "2015-03-22 22:22:22 -0:00", 0));
